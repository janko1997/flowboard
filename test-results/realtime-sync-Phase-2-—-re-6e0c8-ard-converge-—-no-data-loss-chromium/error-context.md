...
- Name: realtime-sync.spec.ts >> Phase 2 — real-time sync >> concurrent moves of the same card converge — no data loss
- Location: tests\e2e\realtime-sync.spec.ts:143:7
...
Locator: locator('[data-column-id="col-todo"] [data-card-id="card-2"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-column-id="col-todo"] [data-card-id="card-2"]')
      ...
      - main [ref=e76]:
        - generic [ref=e77]:
          - generic [ref=e78]:
            ...
            - generic [ref=e86]:
              - generic [ref=e87]:
                - generic "You" [ref=e88]: BC
                - generic "Calm Lynx" [ref=e89]: CL
                - generic "Cool Owl" [ref=e90]: CO
                - generic "Swift Deer" [ref=e91]: SD
